...
- `.claude/skills/` - Claude Code skill definitions (extend, narrate, md-to-mulmo)
- `lib/` - Built TypeScript output (generated by `yarn build`), `lib/cli/index.js` is npm bin entry
